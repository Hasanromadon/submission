                ...
                <div class="footer__wrapper">
                    ...
                    <div class="footer__social-media">
                        ...
                        <ul class="footer__social-media__list">
                            <li> <a href="#" class="footer__social-media__link"> <img src="${iconFb}" alt="facebook"></a></li>
                            <li> <a href="#" class="footer__social-media__link"> <img src="${iconIg}" alt="instagram"></a></li>
                            <li> <a href="#" class="footer__social-media__link"> <img src="${iconTw}" alt="twitter"> </a></li>
                        </ul>
                    </div>
