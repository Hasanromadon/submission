...
class Navbar extends HTMLElement {
  ...
  render() {
    this.innerHTML = ` <a class="skip-link" tabindex="0" href="#main">LEWATI KE KONTEN UTAMA</a>
        ...
        <nav id="drawer">
            <ul>
              <li class="drawer__list"><a href="/"> Beranda</a></li>
              <li class="drawer__list"><a href="#"> Favorit</a></li>
              <li class="drawer__list"><a href="https://www.linkedin.com/in/hasan-romadon/" target="_blank">Tentang</a></li>
            </ul>
        </nav>`;
  }
}
