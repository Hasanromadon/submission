    ...
    <section class="detail__section">
      <nav class="detail__nav">
          <ul class="nav-list">
              ...
              <li id="likeButtonContainer" class="nav-list__item">
...
const createFavoriteRestaurantButtonTemplate = () => `
  <button id="likeButton" class="like btn btn-favorite btn__primary--outlined">
     Favoritkan
  </button>
`;

const createUnFavoriteRestaurantButtonTemplate = () => `
  <button id="likeButton" class="like btn btn-favorite favorited">
    Favorit
  </button>
`;
...
export {
  ...
  createFavoriteRestaurantButtonTemplate, createUnFavoriteRestaurantButtonTemplate,
};
